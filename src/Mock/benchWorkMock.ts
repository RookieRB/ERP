import {InteractionHistoryData, NotificationsData} from "../views/user/modules/dashboard/workbench/type.ts";
...
export const benchWorkInteractionDataArray:Array<InteractionHistoryData>= [
    {
        ...
        groupMember: [
            ...
            'src/assets/avatar02.jpg',
            'src/assets/avatar04.jpg',
        ]
    },
    {
        date: 'Sept 20',
        ...
        groupMember: [
            'src/assets/avatar.jpg',
            'src/assets/avatar01.jpg',
            'src/assets/avatar03.jpg',
        ]
    },
    {
        date: 'Sept 25',
...
export const benchWorkNotificationsDataArray:Array<NotificationsData>=[
    ...
    },
    {
        ...
        description:'Sarah Thompson Left a Comment on\n Your Video: "Mastering the Art of  \n Photography"',
        type: 'Invite',
        time: '1 hour ago',
    },
    {
